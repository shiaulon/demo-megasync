...
> A demo usa somente dados fictícios, não exige login e não se conecta ao ambiente de produção. As interações são locais e reiniciadas ao atualizar a página.
